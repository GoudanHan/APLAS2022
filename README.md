...
<ol>
  ...
  <li>Then, go to <a href="https://www.kaggle.com/code/tianyuhan2/inference-7fa4ae/edit"> Inference notebook </a> and click on Copy & Edit. Once you are in the notebook, on the right side bar, click on the Settings menu. If your account is yet to be phone verified, it should look like this picture. Click on the <b>Get Phone Verified</b> and verify your account using your phone number.
  <p align="center">
  <img src="Image/sidebar.png" width="550" title="hover text" alt="Sidebar before phone verified..">
  </p>
  
  
  </li>
  <li>If your account is already phone verified, the Settings menu should look like this picture. Then, under Accelerator, click on GPU. Also, make sure that the Internet switch is on.</li>
  <li>Run the notebook, enter the inputs as prompted, and get the results!</li>
</ol>
